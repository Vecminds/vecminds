...
const team = [
  ...
  },
  {
    ...
    role: "AI Engineer",
    specialty:
      "Builds LLM pipelines, RAG systems, and AI agents in Python and LangChain that quietly do real work in the background.",
    x: null,
    linkedin: null,
    github: null,
    website: null,
  },
  {
    ...
    specialty:
      "Ships web and mobile apps in React, Next.js, and TypeScript. Cares more about clean state machines than chasing frameworks.",
    x: null,
    linkedin: null,
    github: null,
    website: null,
  },
  {
    ...
    specialty:
      "Builds APIs, integrations, and the backend infrastructure that keeps production calm, mostly in Node.js and .NET.",
    x: null,
    linkedin: null,
    github: null,
    website: null,
