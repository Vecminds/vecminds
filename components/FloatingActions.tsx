...
export default function FloatingActions() {
  ...
  return (
    <div
      ref={containerRef}
      className={`fixed right-4 sm:right-5 z-50 flex items-center gap-2 sm:gap-3 transition-[opacity,transform] duration-200 ease-out ${
        hidden
    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {/* WhatsApp — stagger last (closest to toggle) */}
        <Link
          href={WHATSAPP_URL}
          target="_blank"
